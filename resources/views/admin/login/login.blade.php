            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="mt-5 text-center">
                        <div>
                            <p>© <script>document.write(new Date().getFullYear())</script> <span data-translate="footer.crafted">Crafted with</span> <i class="mdi mdi-heart text-danger"></i> <span data-translate="footer.by">by Ahmad Efendi</span></p>
                        </div>
                    </div>
                </div>
            </div>
