 ...
 <section id="hero" class="d-flex align-items-center">
  ...
  <footer id="footer">
    <div class="container py-4">
      <div class="copyright">
        &copy; <span data-translate="footer.copyright">Copyright</span> <strong><span>Ahmad Efendi</span></strong>. <span data-translate="footer.rights">All Rights Reserved</span>
      </div>
      <div class="credits">
        <span data-translate="footer.designed">Designed by</span> <a href="#">Ahmad Efendi</a>
      </div>
    </div>
  </footer><!-- End Footer -->
